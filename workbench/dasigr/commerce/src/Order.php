...
use Dasigr\Commerce\Helper;
use Dasigr\Commerce\Money;
use Dasigr\Commerce\RegionInterface;
use Dasigr\Commerce\Exception\InvalidOrderException;
...
class Order extends Helper {
     ...
     * Create a New Order
     * 
     * @param \Dasigr\Commerce\RegionInterface $region
     * @return void
     */
    ...
    /**
     * Get the toal discount parameter
     * 
     * @return Money
     */
