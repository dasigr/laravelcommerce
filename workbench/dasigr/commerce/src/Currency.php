...
class Currency {
    ...
    public function __construct($name)
    {
        ...
        $currencies = array_merge(
            json_decode(file_get_contents(__DIR__ . '/config/currency_iso.json'), true), json_decode(file_get_contents(__DIR__ . '/config/currency_non_iso.json'), true)
        );
